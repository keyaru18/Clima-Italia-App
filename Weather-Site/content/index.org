...
# URL de la API
URL = 'http://api.openweathermap.org/data/3.0/weather?lat={LATITUD}&lon={LONGITUD}&appid={API_KEY}&units=metric'
...
if response.status_code == 200:
    ...
    # Si deseas extraer información específica, como la temperatura, por ejemplo:
    temperatura = data['main']['temp']
    print(f"La temperatura en Italia es: {temperatura} °C")
else:
